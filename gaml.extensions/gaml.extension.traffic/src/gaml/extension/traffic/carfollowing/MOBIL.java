/*******************************************************************************************************
 *
 * MOBIL.java, in gaml.extension.traffic, is part of the source code of the
...
import static gaml.extension.traffic.DrivingSkill.getAccBias;
import static gaml.extension.traffic.DrivingSkill.getAccGainThreshold;
import static gaml.extension.traffic.DrivingSkill.getAllowedLanes;
import static gaml.extension.traffic.DrivingSkill.getLCCooldown;
import static gaml.extension.traffic.DrivingSkill.getLaneChangeLimit;
import static gaml.extension.traffic.DrivingSkill.getLeadingDistance;
import static gaml.extension.traffic.DrivingSkill.getMaxSafeDeceleration;
import static gaml.extension.traffic.DrivingSkill.getNumLanesOccupied;
import static gaml.extension.traffic.DrivingSkill.getPolitenessFactor;
import static gaml.extension.traffic.DrivingSkill.getProbaUseLinkedRoad;
import static gaml.extension.traffic.DrivingSkill.getRightSideDriving;
import static gaml.extension.traffic.DrivingSkill.getSpeed;
import static gaml.extension.traffic.DrivingSkill.getTimeSinceLC;
import static gaml.extension.traffic.DrivingSkill.getVehicleLength;
import static gaml.extension.traffic.DrivingSkill.setFollower;
import static gaml.extension.traffic.DrivingSkill.setLeadingDistance;
import static gaml.extension.traffic.DrivingSkill.setLeadingSpeed;
import static gaml.extension.traffic.DrivingSkill.setLeadingVehicle;
import static gaml.extension.traffic.DrivingSkill.setTimeSinceLC;
import static gaml.extension.traffic.carfollowing.Utils.findFollower;
import static gaml.extension.traffic.carfollowing.Utils.findLeader;
import static gaml.extension.traffic.carfollowing.Utils.rescaleProba;
...
import gaml.extension.traffic.RoadNodeSkill;
