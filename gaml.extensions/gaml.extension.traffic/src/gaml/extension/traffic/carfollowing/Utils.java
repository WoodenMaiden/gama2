/*******************************************************************************************************
 *
 * Utils.java, in gaml.extension.traffic, is part of the source code of the
...
import static gaml.extension.traffic.DrivingSkill.getCurrentRoad;
import static gaml.extension.traffic.DrivingSkill.getCurrentTarget;
import static gaml.extension.traffic.DrivingSkill.getDistanceToCurrentTarget;
import static gaml.extension.traffic.DrivingSkill.getLinkedLaneLimit;
import static gaml.extension.traffic.DrivingSkill.getMinSafetyDistance;
import static gaml.extension.traffic.DrivingSkill.getNextRoad;
...
import static gaml.extension.traffic.DrivingSkill.isViolatingOneway;
import static gaml.extension.traffic.DrivingSkill.readyToCross;
