/*******************************************************************************************************
 *
 * PerceiveStatement.java, in gaml.extension.simplebdi, is part of the source code of the
				...
				if (threshold == null || emotion != null && threshold != null && SimpleBdiArchitecture.getEmotion(scope,
					...
					if (inArg instanceof Float || inArg instanceof Integer || inArg instanceof Double) {
						...
						if (obj instanceof IContainer) {
							temp = gaml.core.operators.Spatial.Queries.at_distance(scope, (IContainer) obj,
					...
					if (inArg instanceof gaml.core.types.GamaGeometryType || inArg instanceof GamaShape) {
						IList temp = GamaListFactory.create();
						final IShape geom = Cast.asGeometry(scope, inArg);
						if (obj instanceof IContainer) {
							temp = gaml.core.operators.Spatial.Queries.overlapping(scope, (IContainer) obj,
