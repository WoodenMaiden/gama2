/*******************************************************************************************************
 *
 * EnforcementStatement.java, in gaml.extension.simplebdi, is part of the source code of the
			...
			if (law != null) {
				...
				if (lawToTest != null) {
					if (lawToTest.getContextExpression() == null
							|| gaml.core.operators.Cast.asBool(scope, lawToTest.getContextExpression().value(scope))) {
