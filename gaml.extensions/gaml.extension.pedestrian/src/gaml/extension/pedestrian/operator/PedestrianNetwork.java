/*******************************************************************************************************
 *
 * PedestrianNetwork.java, in gaml.extension.pedestrian, is part of the source code of the GAMA modeling and simulation
 * platform (v.1.9.2).
 *
...
import gaml.extension.pedestrian.skills.PedestrianRoadSkill;
...
public class PedestrianNetwork {
	 ...
	 * @param bounds
	 *            the bounds
	 * @param regular_network
	 *            the regular network
	 * @param openArea
	 *            the open area
	 * @param randomDist
	 *            the random dist
	 * @param valDistForOpenArea
	 *            the val dist for open area
	 * @param valDensityOpenArea
	 *            the val density open area
	 * @param cleanNetwork
	 *            the clean network
	 * @param toleranceClip
	 *            the tolerance clip
	 * @param toleranceTriang
	 *            the tolerance triang
	 * @param minDistPath
	 *            the min dist path
	 * @param simplicationDistance
	 *            the simplication distance
	 * @param sizeSquare
	 *            the size square
	 * @return the i list
	 */
	 ...
	 * @param scope
	 *            the scope
	 * @param pedestrianArea
	 *            the pedestrian area
	 * @param obst
	 *            the obst
	 * @param buffer
	 *            the buffer
	 * @param pedestrianNetwork
	 *            the pedestrian network
	 * @param regularNetwork
	 *            the regular network
	 * @return the i list
	 */
	/*
