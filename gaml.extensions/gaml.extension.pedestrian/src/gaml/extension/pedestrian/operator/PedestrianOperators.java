/*******************************************************************************************************
 *
 * PedestrianOperators.java, in gaml.extension.pedestrian, is part of the source code of the GAMA modeling and simulation platform
 * (v.1.9.2).
 *
...
/**
 * The Class PedestrianOperators.
 */
public class PedestrianOperators {
	 ...
	 * @param minDistPath
	 *            the min dist path
	 * @param simplificationDist
	 *            the simplification dist
	 * @param SizeSquares
	 *            the size squares
	 * @return the i list
	 */
	 ...
	 * @param simplificationDist
	 *            the simplification dist
	 * @param sizeSquareOpti
	 *            the size square opti
	 * @return the i list
	 */
	@operator (
			value = "generate_pedestrian_network",
