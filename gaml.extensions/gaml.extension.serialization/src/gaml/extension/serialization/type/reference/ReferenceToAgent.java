/*******************************************************************************************************
 *
 * ReferenceToAgent.java, in gaml.extension.serialization, is part of the source code of the GAMA modeling and
...
public class ReferenceToAgent {
	...
	public String toString() {
		...
		for (int i = 0; i < species.size(); i++) { res = "/" + species.get(i) + index.get(i); }
		return res;
	}
