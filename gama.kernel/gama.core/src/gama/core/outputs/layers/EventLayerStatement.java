/*******************************************************************************************************
 *
 * EventLayerStatement.java, in gama.core, is part of the source code of the
...
@facets (
		value = { @facet (
				...
				type = { IType.STRING },
				optional = false,
				doc = @doc ("the type of event captured: basic events include #mouse_up, #mouse_down, #mouse_move, #mouse_drag, #mouse_exit, #mouse_enter, #mouse_menu, #arrow_down, #arrow_up, #arrow_left, #arrow_right, #escape, #tab, #enter, #page_up, #page_down or a character")),
				@facet (
						name = IKeyword.TYPE,
						type = IType.STRING,
						optional = true,
