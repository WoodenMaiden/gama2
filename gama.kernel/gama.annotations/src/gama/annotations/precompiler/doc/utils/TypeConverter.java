/*******************************************************************************************************
 *
 * TypeConverter.java, in gama.annotations, is part of the source code of the
...
public class TypeConverter {
	...
	private HashMap<String, String> initProperNameTypeMap() {
		...
		hm.put("gama.ui.display.opengl.files.Gama3DSFile", "file");
		hm.put("gama.ui.display.opengl.files.GamaObjFile", "file");
		hm.put("gama.core.serializer.gaml.GamaSavedSimulationFile", "file");

		// Colors
		hm.put("gama.core.util.GamaColor", "rgb");
		hm.put("gaml.core.operators.Colors.GamaPalette", "list<rgb>");
		hm.put("gaml.core.operators.Colors.GamaGradient", "map<rgb,float>");
		hm.put("gaml.core.operators.Colors.GamaScale", "map<float,rgb>");
		...
		hm.put("gaml.core.types.IType", "any GAML type");
		hm.put("gaml.core.expressions.IExpression", "any expression");
		...
		hm.put("gaml.core.species.ISpecies", "species");
		...
		// BDI
		hm.put("gaml.core.architecture.simplebdi.Predicate", "predicate");
		hm.put("gaml.core.architecture.simplebdi.BDIPlan", "BDIPlan");
		hm.put("gaml.core.architecture.simplebdi.Emotion", "emotion");
		hm.put("gaml.core.architecture.simplebdi.MentalState", "mental_state");
		hm.put("gaml.core.architecture.simplebdi.SocialLink", "social_link");

		// FIPA
		hm.put("gaml.core.extensions.fipa.Conversation", "conversation");

		hm.put("gaml.core.extensions.fipa.Message", "message");
		hm.put("gama.core.extensions.messaging.GamaMessage", "message");
		hm.put("gaml.core.extensions.fipa.FIPAMessage", "message");
		...
		hm.put("gaml.core.types.GamaKmlExport", "kml");
		...
		hm.put("gaml.core.descriptions.ActionDescription", "action");
