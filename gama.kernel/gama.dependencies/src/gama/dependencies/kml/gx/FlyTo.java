...
import gama.dependencies.kml.Camera;
import gama.dependencies.kml.LookAt;
import gama.dependencies.kml.annotations.Obvious;

/**
 * <gx:FlyTo>
 * <p>
 * <gx:FlyTo> specifies a point in space to which the browser will fly during a tour. It must contain one AbstractView,
 * and should contain <gx:duration> and <gx:flyToMode> elements, which specify the time it takes to fly to the defined
 * point from the current point, and the method of flight, respectively.
 * </p>
 *
 * Syntax:
 *
...
@XmlType (
		name = "FlyToType",
		propOrder = { "duration", "flyToMode", "abstractView" })
@XmlRootElement (
		name = "FlyTo",
...
public class FlyTo extends TourPrimitive implements Cloneable {
	 ...
	 * </p>
	 * <p>
	 * <gx:FlyTo> <gx:flyToMode>bounce</gx:flyToMode> <gx:duration>10.2</gx:duration> <!-- AbstractView --> ... <!--
	 * /AbstractView --> </gx:FlyTo>
	 * </p>
	 * <p>
	 * <gx:duration> extends gx:TourPrimitive by specifying a time-span for events. The time is written as seconds using
	 * XML's double datatype.
	 * </p>
	 * <p>
	 ...
	 * </p>
	 * <p>
	 * Specifies the length of time over which the update takes place. Integer, float, and color fields are smoothly
	 * animated from original to new value across the duration; boolean, string, and other values that don't lend to
	...
	@Override
	public int hashCode() {
		return Objects.hash(duration, flyToMode, abstractView);
	}
