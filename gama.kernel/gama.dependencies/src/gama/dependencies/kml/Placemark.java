/*******************************************************************************************************
 *
 * Placemark.java, in gama.dependencies, is part of the source code of the
 ...
 * <Placemark>
 * <p>
 * A Placemark is a Feature with associated Geometry. In Google Earth, a Placemark appears as a list item in the Places
...
@XmlType (
		name = "PlacemarkType",
		propOrder = { "geometry", "placemarkSimpleExtension", "placemarkObjectExtension" })
@XmlRootElement (
		name = "Placemark",
...
public class Placemark extends Feature implements Cloneable {
	 ...
	 * <Geometry>
	 * <p>
	 * This is an abstract element and cannot be used directly in a KML file. It provides a placeholder object for all
	 * derived Geometry objects.
	 * </p>
	 * 
	 * Syntax:
	 *
	...
	@XmlElementRef (
			...
			namespace = "http://www.opengis.net/kml/2.2",
			required = false) protected Geometry geometry;
	
	/** The placemark simple extension. */
	@XmlElement (
			name = "PlacemarkSimpleExtensionGroup")
	@XmlSchemaType (
			name = "anySimpleType") protected List<Object> placemarkSimpleExtension;
	/**
	 * <Object>
	 * <p>
	 ...
	 */
	@XmlElement (
			name = "PlacemarkObjectExtensionGroup") protected List<AbstractObject> placemarkObjectExtension;
	 ...
	 *         {@code <}{@link Geometry}{@code>} {@code <}{@link Point}{@code>} {@code <}{@link LinearRing}{@code>} {@code <}{@link Polygon}{@code>} {@code <}{@link Track}{@code>} {@code <}{@link MultiTrack}{@code>} {@code <}{@link Model}{@code>} {@code <}{@link LineString}{@code>} {@code <}{@link MultiGeometry}{@code>}
	 * 
	 */
	 ...
	 * 
	 */
	public void setGeometry(final Geometry value) { this.geometry = value; }
	...
	public List<Object> getPlacemarkSimpleExtension() {
		if (placemarkSimpleExtension == null) { placemarkSimpleExtension = new ArrayList<>(); }
	...
	public List<AbstractObject> getPlacemarkObjectExtension() {
		if (placemarkObjectExtension == null) { placemarkObjectExtension = new ArrayList<>(); }
	...
	public int hashCode() {
		...
		return prime * result + (placemarkObjectExtension == null ? 0 : placemarkObjectExtension.hashCode());
	}

	@Override
	public boolean equals(final Object obj) {
		if (this == obj) return true;
		if ((obj == null) || !super.equals(obj) || !(obj instanceof Placemark)) return false;
		...
		if (placemarkSimpleExtension == null) {
			if (other.placemarkSimpleExtension != null) return false;
		} else if (!placemarkSimpleExtension.equals(other.placemarkSimpleExtension)) return false;
		if (placemarkObjectExtension == null) {
			if (other.placemarkObjectExtension != null) return false;
		} else if (!placemarkObjectExtension.equals(other.placemarkObjectExtension)) return false;
		return true;
	}
	...
	public Placemark clone() {
		...
		copy.placemarkSimpleExtension.addAll(placemarkSimpleExtension);
		copy.placemarkObjectExtension = new ArrayList<>(getPlacemarkObjectExtension().size());
		for (AbstractObject iter : placemarkObjectExtension) { copy.placemarkObjectExtension.add(iter.clone()); }
		return copy;
	}
