/*******************************************************************************************************
 *
 * NetworkLinkControl.java, in gama.dependencies, is part of the source code of the
...
@XmlType (
		...
		propOrder = { "minRefreshPeriod", "maxSessionLength", "cookie", "message", "linkName", "linkDescription",
				"linkSnippet", "expires", "update", "abstractView", "networkLinkControlSimpleExtension",
...
public class NetworkLinkControl implements Cloneable {
	 ...
	 * <minrefreshperiod>
	 * <p>
	 * Specified in seconds, <minRefreshPeriod> is the minimum allowed time between fetches of the file. This parameter
	 * allows servers to throttle fetches of a particular file and to tailor refresh rates to the expected rate of
	 * change to the data. For example, a user might set a link refresh to 5 seconds, but you could set your minimum
	 * refresh period to 3600 to limit refresh updates to once every hour.
	 * </p>
	 * 
	 * 
	 * 
	 */
	@XmlElement (
			defaultValue = "0.0") protected double minRefreshPeriod;
	/**
	 * <maxsessionlength>
	 * <p>
	 ...
	 */
	@XmlElement (
			defaultValue = "-1.0") protected double maxSessionLength;
	/**
	 * <cookie>
	 * <p>
	 * Use this element to append a string to the URL query on the next refresh of the network link. You can use this
	 * data in your script to provide more intelligent handling on the server side, including version querying and
	 ...
	 * <message>
	 * <p>
	 * You can deliver a pop-up message, such as usage guidelines for your network link. The message appears when the
	 * network link is first loaded into Google Earth, or when it is changed in the network link control.
	 * </p>
	 * 
	 * 
	 * 
	 ...
	 * <linkname>
	 * <p>
	 * You can control the name of the network link from the server, so that changes made to the name on the client side
	 ...
	 * <linkdescription>
	 * <p>
	 * You can control the description of the network link from the server, so that changes made to the description on
	 * the client side are overridden by the server.
	 * </p>
	 * 
	 * 
	 * 
	 ...
	 * client side are overridden by the server. <linkSnippet> has a maxLines attribute, an integer that specifies the
	 ...
	 * <expires>
	 * <p>
	 * You can specify a date/time at which the link should be refreshed. This specification takes effect only if the
	 * <refreshMode> in <Link> has a value of onExpire. See <refreshMode>
	 * </p>
	 * 
	 * 
	 * 
	 ...
	 * <targetHref> specifies the .kml or .kmz file whose data (within Google Earth) is to be modified. <Update> is
	 * always contained in a NetworkLinkControl. Furthermore, the file containing the NetworkLinkControl must have been
	 * loaded by a NetworkLink. See the "Topics in KML" page on Updates for a detailed example of how Update works.
	 * </p>
	 * <p>
	 * With <Update>, you can specify any number of Change, Create, and Delete tags for a .kml file or .kmz archive that
	 * has previously been loaded with a network link. See <Update>.
	 * </p>
	 * 
	 * Syntax:
	 *
	 ...
	 * @see: Note: This element was deprecated in KML Release 2.1 and is replaced by <Link>, which provides the
	 *       additional functionality of Regions. The <Url> tag will still work in Google Earth, but use of the newer
	 *       <Link> tag is encouraged.
	 * @see: Use this element to set the location of the link to the KML file, to define the refresh options for the
	 *       server and viewer changes, and to populate a variable to return useful client information to the server.
	 * 
	 * 
	 * 
	 */
	@XmlElement (
			name = "Update") protected Update update;
	/**
	 * <abstractview>
	 * <p>
	...
	@XmlSchemaType (
			name = "anySimpleType") protected List<Object> networkLinkControlSimpleExtension;
	/**
	 * <Object>
	 * <p>
	 ...
	 */
	@XmlElement (
			name = "NetworkLinkControlObjectExtensionGroup") protected List<AbstractObject> networkLinkControlObjectExtension;
	 ...
	 * 
	 */
	public double getMinRefreshPeriod() { return minRefreshPeriod; }
	 ...
	 * 
	 */
	public void setMinRefreshPeriod(final double value) { this.minRefreshPeriod = value; }
	 ...
	 * 
	 */
	public double getMaxSessionLength() { return maxSessionLength; }
	 ...
	 * 
	 */
	public void setMaxSessionLength(final double value) { this.maxSessionLength = value; }
	 ...
	 * 
	 */
	public void setCookie(final String value) { this.cookie = value; }
	 ...
	 * 
	 */
	public void setMessage(final String value) { this.message = value; }
	 ...
	 * 
	 */
	public void setLinkName(final String value) { this.linkName = value; }
	 ...
	 * 
	 */
	public void setLinkDescription(final String value) { this.linkDescription = value; }
	 ...
	 * 
	 */
	public Snippet getLinkSnippet() { return linkSnippet; }
	 ...
	 * 
	 */
	public void setLinkSnippet(final Snippet value) { this.linkSnippet = value; }
	 ...
	 * 
	 */
	public void setExpires(final String value) { this.expires = value; }
	 ...
	 * 
	 */
	public void setUpdate(final Update value) { this.update = value; }
	...
	public List<Object> getNetworkLinkControlSimpleExtension() {
		if (networkLinkControlSimpleExtension == null) { networkLinkControlSimpleExtension = new ArrayList<>(); }
	...
	@Override
	public int hashCode() {
		return Objects.hash(minRefreshPeriod, maxSessionLength, cookie, message, linkName, linkDescription, linkSnippet, expires, update, abstractView,
				networkLinkControlSimpleExtension, networkLinkControlObjectExtension);
	}

	@Override
	public boolean equals(final Object obj) {
		if (this == obj) return true;
		if ((obj == null) || !(obj instanceof NetworkLinkControl)) return false;
		NetworkLinkControl other = (NetworkLinkControl) obj;
		if (minRefreshPeriod != other.minRefreshPeriod) return false;
		if (maxSessionLength != other.maxSessionLength) return false;
		if (cookie == null) {
		...
		if (linkName == null) {
			if (other.linkName != null) return false;
		} else if (!linkName.equals(other.linkName)) return false;
		if (linkDescription == null) {
			if (other.linkDescription != null) return false;
		} else if (!linkDescription.equals(other.linkDescription)) return false;
		if (linkSnippet == null) {
			if (other.linkSnippet != null) return false;
		} else if (!linkSnippet.equals(other.linkSnippet)) return false;
		if (expires == null) {
		...
		if (networkLinkControlSimpleExtension == null) {
			if (other.networkLinkControlSimpleExtension != null) return false;
		} else if (!networkLinkControlSimpleExtension.equals(other.networkLinkControlSimpleExtension))
			return false;
		if (networkLinkControlObjectExtension == null) {
			if (other.networkLinkControlObjectExtension != null) return false;
		} else if (!networkLinkControlObjectExtension.equals(other.networkLinkControlObjectExtension))
			return false;
		return true;
	}
	 ...
	 */
	public NetworkLinkControl
			addToNetworkLinkControlObjectExtension(final AbstractObject networkLinkControlObjectExtension) {
	 ...
	 */
	public NetworkLinkControl
			withNetworkLinkControlSimpleExtension(final List<Object> networkLinkControlSimpleExtension) {
	 ...
	 */
	public NetworkLinkControl
			withNetworkLinkControlObjectExtension(final List<AbstractObject> networkLinkControlObjectExtension) {
	...
	public NetworkLinkControl clone() {
		...
		copy.networkLinkControlSimpleExtension.addAll(networkLinkControlSimpleExtension);
		copy.networkLinkControlObjectExtension =
				new ArrayList<>(getNetworkLinkControlObjectExtension().size());
