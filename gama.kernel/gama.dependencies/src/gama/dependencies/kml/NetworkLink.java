/*******************************************************************************************************
 *
 * NetworkLink.java, in gama.dependencies, is part of the source code of the
    ...
    implements Cloneable
{
    ...
    @XmlElement(name = "Url")
    @Deprecated
    protected gama.dependencies.kml.Link url;
    /**
    ...
    protected gama.dependencies.kml.Link link;
     ...
     * @return
     *     possible object is
     *     {@link gama.dependencies.kml.Link}
     *     
     */
    public gama.dependencies.kml.Link getUrl() {
        return url;
    }
     ...
     *     
     */
    public void setUrl(gama.dependencies.kml.Link value) {
        this.url = value;
    }
     ...
     *     
     */
    public gama.dependencies.kml.Link getLink() {
        return link;
    }
     ...
     *     
     */
    public void setLink(gama.dependencies.kml.Link value) {
        this.link = value;
    }
    ...
    /**
     * Creates a new instance of {@link gama.dependencies.kml.Link} and set it to url.
     * 
     ...
     * 
     */
    public gama.dependencies.kml.Link createAndSetUrl() {
        gama.dependencies.kml.Link newValue = new gama.dependencies.kml.Link();
        this.setUrl(newValue);
        return newValue;
    }

    /**
     * Creates a new instance of {@link gama.dependencies.kml.Link} and set it to link.
     * 
     * This method is a short version for:
     * <code>
     * Link link = new Link();
     ...
     * 
     */
    public gama.dependencies.kml.Link createAndSetLink() {
        gama.dependencies.kml.Link newValue = new gama.dependencies.kml.Link();
     ...
     *     required parameter
     */
    public NetworkLink withUrl(final gama.dependencies.kml.Link url) {
        this.setUrl(url);
        return this;
    }
     ...
     *     required parameter
     */
    public NetworkLink withLink(final gama.dependencies.kml.Link link) {
        this.setLink(link);
        return this;
    }
    ...
    @Obvious
    @Override
    public NetworkLink withAtomLink(final gama.dependencies.kml.atom.Link atomLink) {
    ...
    public NetworkLink clone() {
        ...
        copy.url = ((url == null)?null:((gama.dependencies.kml.Link) url.clone()));
        copy.link = ((link == null)?null:((gama.dependencies.kml.Link) link.clone()));
