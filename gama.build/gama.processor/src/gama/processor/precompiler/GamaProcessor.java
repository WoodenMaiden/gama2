/*******************************************************************************************************
 *
 * GamaProcessor.java, in gama.processor, is part of the source code of the
...
import gama.processor.precompiler.tests.TestProcessor;
...
public class GamaProcessor extends AbstractProcessor implements Constants {
	...
	protected void writeImmutableHeader(final StringBuilder sb) {
		...
		sb.append(ln).append("import static gaml.core.operators.Cast.*;");
		sb.append(ln).append("import static gaml.core.operators.Spatial.*;");
		sb.append(ln).append("import static gama.annotations.common.interfaces.IKeyword.*;");
		sb.append(ln).append("@SuppressWarnings({ \"rawtypes\", \"unchecked\", \"unused\" })");
		sb.append(ln).append(ln).append("public class GamlAdditions extends gaml.core.compilation.AbstractGamlAdditions")
				.append(" {");
