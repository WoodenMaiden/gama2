/*******************************************************************************************************
 *
 * Constants.java, in gama.processor, is part of the source code of the
...
import gama.processor.precompiler.doc.DocProcessor;
...
public interface Constants {
	...
	/** The basic skill. */
	String BASIC_SKILL = "gaml.core.skills.Skill";
	...
	String[] EXPLICIT_IMPORTS = { "gaml.core.operators.Random", "gaml.core.operators.Maths", "gaml.core.operators.Points",
			"gaml.core.operators.Spatial.Properties", "gaml.core.operators.System" };
