/*******************************************************************************************************
 *
 * SymbolProcessor.java, in gama.processor, is part of the source code of the
...
public class SymbolProcessor extends ElementProcessor<symbol> {
	...
	protected boolean validateElement(final ProcessorContext context, final Element e) {
		boolean result =
				assertClassExtends(context, true, (TypeElement) e, context.getType("gaml.core.compilation.ISymbol"));
