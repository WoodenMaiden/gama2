/*******************************************************************************************************
 *
 * FileProcessor.java, in gama.processor, is part of the source code of the
...
public class FileProcessor extends ElementProcessor<file> {
	...
	protected boolean validateElement(final ProcessorContext context, final Element e) {
		boolean result =
				assertClassExtends(context, true, (TypeElement) e, context.getType("gama.core.util.file.IGamaFile"));
