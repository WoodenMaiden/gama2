/*******************************************************************************************************
 *
 * HeadlessExperiment.java, in gaml.compiler, is part of the source code of the
 ...
 * </p>
 * <ul>
 *   <li>{@link gaml.compiler.gaml.HeadlessExperiment#getKey <em>Key</em>}</li>
 *   <li>{@link gaml.compiler.gaml.HeadlessExperiment#getFirstFacet <em>First Facet</em>}</li>
 ...
 *   <li>{@link gaml.compiler.gaml.HeadlessExperiment#getFacets <em>Facets</em>}</li>
 *   <li>{@link gaml.compiler.gaml.HeadlessExperiment#getBlock <em>Block</em>}</li>
 * </ul>
 *
...
public interface HeadlessExperiment extends EObject
{
   ...
   * @see #setKey(String)
   * @see gaml.compiler.gaml.GamlPackage#getHeadlessExperiment_Key()
   * @model
   * @generated
   */
  String getKey();
  ...
  /**
   * Sets the value of the '{@link gaml.compiler.gaml.HeadlessExperiment#getKey <em>Key</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see gaml.compiler.gaml.GamlPackage#getHeadlessExperiment_FirstFacet()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link gaml.compiler.gaml.HeadlessExperiment#getFirstFacet <em>First Facet</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see gaml.compiler.gaml.GamlPackage#getHeadlessExperiment_Facets()
   ...
   * @see #setBlock(Block)
   * @see gaml.compiler.gaml.GamlPackage#getHeadlessExperiment_Block()
   * @model containment="true"
   * @generated
   */
  Block getBlock();
  ...
  /**
   * Sets the value of the '{@link gaml.compiler.gaml.HeadlessExperiment#getBlock <em>Block</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
