/*******************************************************************************************************
 *
 * GamlLabelProvider.java, in gama.ui.editor, is part of the source code of the GAMA modeling and simulation
 * platform (v.1.9.0).
 *
...
import gama.ui.editor.outline.GamlOutlineTreeProvider;
...
public class GamlLabelProvider extends DefaultEObjectLabelProvider implements IGamlLabelProvider {
	...
	/**
	 * @see gama.core.common.interfaces.IGamlLabelProvider#getText(gaml.core.compilation.ast.ISyntacticElement)
	 */
	@Override
	...
	/**
	 * @see gama.core.common.interfaces.IGamlLabelProvider#getImage(gaml.core.compilation.ast.ISyntacticElement)
	 */
	@Override
