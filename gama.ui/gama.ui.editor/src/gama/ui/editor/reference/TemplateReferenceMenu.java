/*******************************************************************************************************
 *
 * TemplateReferenceMenu.java, in gama.ui.editor, is part of the source code of the GAMA modeling and
 ...
 *
 ********************************************************************************************************/
package gama.ui.editor.reference;
...
public class TemplateReferenceMenu extends GamlReferenceMenu {
	...
	protected void openView() {
		try {
			WorkbenchHelper.getPage().showView("gama.ui.editor.templates");
	...
	/**
	 * @see gama.ui.editor.reference.GamlReferenceMenu#getImage()
	 */
	@Override
	protected Image getImage() { return GamaIcon.named(IGamaIcons.REFERENCE_TEMPLATES).image(); }

	/**
	 * @see gama.ui.editor.reference.GamlReferenceMenu#getTitle()
	 */
	@Override
