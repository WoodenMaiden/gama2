/*******************************************************************************************************
 *
 * AbstractGamlUiModule.java, in gama.ui.editor, is part of the source code of the
...
import gaml.compiler.ide.contentassist.antlr.PartialGamlContentAssistParser;
import gaml.compiler.ide.contentassist.antlr.internal.InternalGamlLexer;
import gaml.compiler.ui.contentassist.GamlProposalProvider;
import gaml.compiler.ui.labeling.GamlDescriptionLabelProvider;
import gaml.compiler.ui.labeling.GamlLabelProvider;
import gaml.compiler.ui.outline.GamlOutlineTreeProvider;
import gaml.compiler.ui.quickfix.GamlQuickfixProvider;
...
public abstract class AbstractGamlUiModule extends DefaultUiModule {
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(gaml.compiler.parser.antlr.internal.InternalGamlLexer.class);
	}
